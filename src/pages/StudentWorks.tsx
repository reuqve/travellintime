...
const videos = [
  ...
  },
  {
    ...
    description: 'Красные против Белых — борьба за будущее страны',
    duration: '5:12',
    author: 'Гетагазов Б.',
    embedUrl: 'https://drive.google.com/file/d/19pK8pFhs95gMRGdoiGLoLY1FWcu4WCQr/preview',
    type: 'google-drive',
  },
  {
    id: 3,
    title: 'Культура во время Великой Отечественной войны',
    description: 'Искусство и культура в годы войны — музыка, литература, живопись',
    duration: '4:30',
    author: 'Ахмедов С.',
  ...
  {
    id: 4,
    title: 'Интервью с ветераном ВОВ Анатолием Николаевичем Порубиным',
    description: 'Личные воспоминания участника Великой Отечественной войны',
    duration: '3:58',
    author: 'Гетагазов Б.',
